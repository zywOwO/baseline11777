...
class DataLoader(data.Dataset):
    ...
    def get_batch(self, split, batch_size=None, seq_per_img=None):
        ...
        for i in range(batch_size):
            ...
            info_dict['id'] = self.info['images'][ix]['file_path']
    ...
    def __getitem__(self, index):
        ...
        return get_npy_data(ix, \
                ...
                os.path.join(self.input_fc_dir, str(self.info['images'][ix]['file_path']) + '.npy'),
                os.path.join(self.input_att_dir, str(self.info['images'][ix]['file_path']) + '.npz'),
                self.use_att
                )
